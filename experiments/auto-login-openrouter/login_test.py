...
from openrouter_pin_solver import OpenRouterPinSolverError, solve_pin_image
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="OpenRouter model to use for captcha solving.",
    )
...
if __name__ == "__main__":
    ...
    except OpenRouterPinSolverError:
        sys.exit(1)
